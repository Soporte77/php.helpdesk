          ...
          <div class="tbl">
            <div class="tbl-row">
              <div class="tbl-cell">
                ...
                <span class="label label-pill label-default" id="lblfechcrea"></span><br>
                <span class="label label-pill label-primary" id="lbldepnom"></span><br>
                <span class="label label-pill label-primary" id="lbldeptonom"></span><br>
