function init(){
   var mostrarBtnRegresar = localStorage.rutaAnterior
   if(mostrarBtnRegresar){
    $("#btnRegresar").show();
   }else{
    $("#btnRegresar").hide();
   }
...
function listardetalle(tick_id){
    ...
    $.post("../../controller/ticket.php?op=mostrar", { tick_id : tick_id }, function (data) {
        ...
        //     window.open('http://localhost/helpdesk/','_self');
        //     // window.open('http://187.237.254.57/HelpDesk/','_self');
        // }else{
